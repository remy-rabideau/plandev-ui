export enum Queries {
  ...
  CHECK_MODEL_COMPATIBILITY_FOR_PLAN = 'check_model_compatibility_for_plan',
  ...
  DELETE_EXTERNAL_EVENT_TYPE = 'delete_external_event_type',
  ...
  DELETE_SEQUENCE_FILTERS = 'delete_sequence_filter',
  DELETE_SEQUENCE_TEMPLATE = 'delete_sequence_template_by_pk',
  ...
  GET_CONSTRAINT_PROCEDURE_EFFECTIVE_ARGUMENTS_BULK = 'getConstraintProcedureEffectiveArgumentsBulk',
